...
const Ayat = ({ data, animate }: Props) => {
  return (
    <section className="relative flex flex-col  w-full items-center justify-center overflow-hidden px-8 py-20 text-center bg-white/70"
      style={{color: data.theme?.contrasfont}}>
        <div className="absolute w-screen h-screen inset-0 backdrop-blur-xs"/>
