...
const FloralCouple = ({ data, animate }: Props) => {
  ...
  <section
    ...
    {/* ORNAMENT */}
      ...
      [-webkit-mask-image:linear-gradient(to_bottom,transparent_0%,black_20%,black_70%,transparent_100%)] ${animate ? "MunculAtas-1 " : "opacity-0"}`}
