    ...
    >
      ...
      >
        ...
        <div className="relative">
          ...
          <button
            onClick={prevImage}
            className="absolute left-2 top-1/2 -translate-y-1/2 text-3xl  bg-white/50 rounded-full"
            >
                <svg
            ...
            <button
            onClick={nextImage}
            className="absolute right-2 top-1/2 -translate-y-1/2 text-3xl  bg-white/50 rounded-full"
            >
                <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
