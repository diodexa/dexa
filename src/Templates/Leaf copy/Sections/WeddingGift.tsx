...
const WeddingGift = ({ data }: Props) => {
  ...
  return (
    <div className="flex w-full tracking-[0.1rem] text-lg"
      style={{color: data.theme?.warna1,}}>
      {data.Background?.Background14 ? (
        <img src={data.Background.Background14}alt=""className="absolute inset-0 w-full h-full object-cover sepia"/>) : (
        <div className="flex flex-col items-center font-ColveticaCond  my-6 w-full h-full border-t" >
          <div className=" relative  w-full opacity-60 z-1 pointer-events-none">
            <img src="/Ornament/Ornament-8.png"  alt="" className=" w-auto absolute opacity-40 "/>
          </div>
        
          <h2 className="text-5xl tracking-[0.2rem] pt-10 "> Wedding Gift</h2>
          <div className="w-full px-2 mt-15 z-2">
            ...
            <div className="border rounded-lg p-1 mb-2 flex flex-col items-center z-2">
          ...
          <div className="h-[100px] relative  w-full opacity-60 ">
            <img src="/Ornament/Ornament-7.png"  alt="" className=" w-auto absolute -top-30"/>
          </div>
        </div>
      )}
