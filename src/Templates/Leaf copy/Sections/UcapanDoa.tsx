  ...
  return (
    <div className="flex flex-col w-full h-full text-lg ">
        ...
        <div className="flex flex-col justify-center  w-full  " >
          <div className="h-[90px] relative  w-full z-1 ">
            <img src="/Ornament/Ornament-2.png"  alt="" className=" w-auto absolute opacity-50"/>
            <img src="/Ornament/Ornament-2.png"  alt="" className=" w-auto absolute opacity-50 rotate-90 -right-3 top-3 pointer-events-none"/>
          </div>
          <h2 className="font-ColveticaCond text-5xl mb-5 z-2">Ucapan & Doa</h2>
          <form className="mx-2 z-2" onSubmit={handleSubmit}>
            <input required
            type="text" 
