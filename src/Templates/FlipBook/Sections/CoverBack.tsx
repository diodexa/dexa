...
const CoverBack = ({data}: Props) => {
  ...
  return (
    <div className="Kertas__half Kertas__half--back flex flex-col justify-center relative" style={{background: data.theme?.warna1, color: data.theme?.warna2}}>
      {data.Background?.CoverBack ? (
        <img src={data.Background.CoverBack} alt="" className="object-cover w-full h-full absolute"/>
      ): (
        <>
          ...
          <div className="flex-1 ">
            ...
            <div className="text-right p-2 text-[0.7rem] lg:text-[0.6rem]  leading-4">
              <p>{data.Sambutan}</p>
              <br />
              <p>Hormat kami,</p>
