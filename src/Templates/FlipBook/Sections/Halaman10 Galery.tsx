    ...
    style={{background: data.theme?.warna1, color: data.theme?.warna2}}>
        <div className="grid grid-cols-6 grid-rows-6 gap-1 h-full w-full p-1" style={{pointerEvents: isActive ? "auto" : "none"}}>
            <div className="col-span-6 row-span-2 relative" >
                <img src={gallery[0]} alt="" className="absolute w-full h-full object-cover object-top"
                onClick={() => openGallery(0)}/>
            </div>
            <div className="col-span-3 row-span-2 relative" >
                <img src={gallery[1]} alt="" className="absolute w-full h-full object-cover object-center"
                onClick={() => openGallery(1)}/>
            </div>
            <div className="col-span-3 row-span-4 relative" >
                <img src={gallery[2]} alt="" className="absolute w-full h-full object-cover object-center"
