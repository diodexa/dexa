...
export const WhatsappButton = ()=> {
    return (
        <div className="fixed cursor-pointer right-5 bottom-10 hover:scale-140 transition pulse">
            <div className="bg-[#45C153] rounded-full p-2 ">
                <a href="https://api.whatsapp.com/send/?phone=6285155001718&text=Hai+Min+Saya+mau+Pesan+Undangan+Digitalnya+dong%21&type=phone_number&app_absent=0" target="_blank"> 
                    <svg
