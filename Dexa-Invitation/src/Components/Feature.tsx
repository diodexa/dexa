        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center  p-8 md:p-12 gap-8">
            ...
            <div className="md:col-span-1 lg:col-span-1 flex flex-col items-start self-stretch"> 
                ...
                <p className="text-justify md:text-lg text-gray-600 dark:text-gray-300 max-w-lg mt-8 mb-auto">
                    Semua yang kamu butuhkan untuk membuat undangan digital yang elegan dan berkesan
                </p>
                ...
                <div className="md:col-span-1 lg:col-span-3 flex flex-col  self-stretch"> 
                    <div className="text-left"> 
                        <ul>
                            ...
                            <li className="relative pl-7 before:content-['✓'] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-5 before:h-5 before:flex before:items-center before:justify-center before:rounded-full before:bg-[#2973B2] before:text-white before:text-xs"> Tema Lengkap Bisa Custom</li>
                            ...
                            <li className="relative pl-7 before:content-['✓'] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-5 before:h-5 before:flex before:items-center before:justify-center before:rounded-full before:bg-[#2973B2] before:text-white before:text-xs"> Galeri foto</li>
                            ...
                            <li className="relative pl-7 before:content-['✓'] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-5 before:h-5 before:flex before:items-center before:justify-center before:rounded-full before:bg-[#2973B2] before:text-white before:text-xs"> Custom warna tema halaman</li>
                        </ul>
                    </div>
                </div>
            </div>
