  ...
  return (
    ...
    style={{background: data.theme?.PrimaryColor, color: data.theme?.bodyFont}}>
        ...
        <div className="relative w-15 h-full bg-white ">
            <div className=" absolute right-1 top-1/2 -translate-y-1/2 w-fit py-2  " style={{color:data.theme?.headingFont}}>
                <h2 className="text-3xl font-Colvetica" style={{writingMode: "sideways-rl", textOrientation: "mixed"}}>{data.Namagroom}</h2>
            </div>
        </div>
