...
const Gallery = ({ data, scrollY }: Props) => {
    ...
    */
    <section className="relative w-full">
      ...
      <div className=" h-screen overflow-hidden absolute inset-0 flex flex-col">
        ...
        {/* JUDUL */}
        <div className="flex justify-center overflow-hidden w-full text-4xl font-semibold py-2">
            <p style={{transform: `translateX(${kiriX *3}%)`}}>Galery</p> 
            <p style={{transform: `translateX(${kananX *3}%)`}}>Foto</p>
        </div>
